    ...
    return (
        <div className="w-full pt-24 px-2 sm:px-12 md:px-36 lg:px-64 xl:px-96">
            <Input
                ...
                label={translations.hotelName}
                placeholder={translations.typeHotelName} />
            <Textarea
                autocomplete={false}
                className="my-4"
                name="description"
                ...
                maxRows={5}
                minRows={5}
                label={translations.hotelDesc}
                placeholder={translations.typeHotelDesc} />
            <Select
                name="currency"
                classNames={{
